...
public class CommUtil {
   ...
   */
    ...
    public static String getCurrentPage( String pageNo){
    	String []arry=pageNo.split(",");
    	pageNo=arry[arry.length-1].trim();
    	return pageNo;
    
    }
    
    //拼接分院名称
    public static String getBEname(String bname,String ename){
    	String bename="【"+bname+"】"+ename;
    	if(bename.length()>13){
    		if(bname.length()>6){
    			bename ="【"+ bname.substring(0,6)+"】" + ename.substring(0,4)+"...";
    		} else{
    			bename = bename.substring(0,12)+"...";
    		}
    	}
    	return bename;
    }
    ...
    public static String getMECProductDec(String productDec){
    	return productDec.length()<28?productDec:productDec.substring(0,28)+"...";
    }
