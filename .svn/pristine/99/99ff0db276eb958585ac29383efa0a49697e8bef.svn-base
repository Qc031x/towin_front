...
public class NewHttpYKMsg {
	
	private static Log logger = LogFactory.getLog(NewHttpYKMsg.class);
	...
	static String account = "JSM40990";//
	//密码
	static String password = "261030";//
	//校验码
	static String veryCode = "68n30omcuidp";
