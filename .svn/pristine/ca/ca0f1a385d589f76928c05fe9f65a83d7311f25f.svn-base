...
public class IPSeeker {
	static Log logger = LogFactory.getLog(IPSeeker.class);
	/**
	 * <pre>
	...
	public static String getIp(HttpServletRequest request){
		if (request.getHeader("x-forwarded-for") == null) {  
			logger.info("getIp RemoteAddr->"+request.getRemoteAddr());
			return request.getRemoteAddr();  
		}  
		logger.info("getIpwwwww getRemoteAddr->"+request.getRemoteAddr());
		logger.info("getIp getHeader->"+request.getHeader("x-forwarded-for"));
